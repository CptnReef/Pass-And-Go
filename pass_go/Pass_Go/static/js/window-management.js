...
// makeDraggable('opponent-video-window', 'ghostpane')
// makeDraggable('user-video-window', 'ghostpane')
// makeDraggable('game-window', 'ghostpane')
...
function makeDraggable(elemId, ghostId) {
    ...
    var pane = document.getElementById(elemId);
    var ghostpane = document.getElementById(ghostId);
    ...
    function animate() {
        ...
        // Snapping to grid - diabling until it can be made smoother and less jaring
